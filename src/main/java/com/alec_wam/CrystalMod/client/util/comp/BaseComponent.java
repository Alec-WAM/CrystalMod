...
public abstract class BaseComponent extends Gui {
	...
	public final static ResourceLocation TEXTURE_SHEET = new ResourceLocation("crystalmod", "textures/gui/components.png");

	protected void bindComponentsSheet() {
		Minecraft.getMinecraft().renderEngine.bindTexture(TEXTURE_SHEET);
	}
	...
	public BaseComponent removeComponent(BaseComponent component) {
	...
	public void updateComp(){
		for(BaseComponent comp2 : components){
			comp2.updateComp();
		}
	}
}