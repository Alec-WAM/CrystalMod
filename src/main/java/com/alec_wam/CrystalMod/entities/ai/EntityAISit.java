package com.alec_wam.CrystalMod.entities.ai;

import com.alec_wam.CrystalMod.entities.EntityOwnable;
...
{
    private EntityOwnable theEntity;
    /** If the EntityTameable is sitting. */
    private boolean isSitting;

    public EntityAISit(EntityOwnable entityIn)
    {
