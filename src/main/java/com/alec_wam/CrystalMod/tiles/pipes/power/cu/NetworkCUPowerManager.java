...
import com.alec_wam.CrystalMod.tiles.pipes.power.PowerTracker;
import com.alec_wam.CrystalMod.tiles.pipes.power.cu.CUPowerPipeNetwork.ReceptorEntry;
  ...
  private void checkReceptors() {
    ...
    for (ReceptorEntry rec : network.getPowerReceptors()) {
      /*if(rec.powerInterface.getDelegate() != null &&
          rec.powerInterface.getDelegate() instanceof com.alec_wam.CrystalMod.api.energy.ICEnergyConnection) {
