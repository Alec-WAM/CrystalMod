...
import com.alec_wam.CrystalMod.tiles.pipes.TileEntityPipe.PipePart;
...
import com.alec_wam.CrystalMod.tiles.pipes.power.cu.TileEntityPipePowerCU;
import com.alec_wam.CrystalMod.tiles.pipes.power.rf.TileEntityPipePowerRF;
...
public class BlockPipe extends EnumBlock<BlockPipe.PipeType> implements ICustomModel {
	...
	public static enum PipeType implements IStringSerializable, com.alec_wam.CrystalMod.blocks.EnumBlock.IEnumMeta{
