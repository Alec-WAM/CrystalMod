...
import com.alec_wam.CrystalMod.integration.jei.JEIUtil;
import com.alec_wam.CrystalMod.items.backpack.gui.GuiBackpack;
import com.alec_wam.CrystalMod.items.backpack.gui.GuiButtonHoverText;
import com.alec_wam.CrystalMod.items.backpack.gui.GuiButtonIcon;
...
import com.alec_wam.CrystalMod.tiles.pipes.estorage.EStorageNetworkClient;
...
import com.alec_wam.CrystalMod.tiles.pipes.estorage.EStorageNetworkClient.SortType;
import com.alec_wam.CrystalMod.tiles.pipes.estorage.client.IGuiScreen;
import com.alec_wam.CrystalMod.tiles.pipes.estorage.client.VScrollbar;
			...
			if(safe){
				...
				if(data !=null && data.stack !=null){
					...
					if(mouseButton == 0 || mouseButton == 1){
						...
						try {
							if(!data.isCrafting)CrystalMod.proxy.sendPacketToServerOnly(new PacketEStorageAddItem(1, slot, amount, EStorageNetwork.compressItem(data)));
						} catch (IOException e) {
							e.printStackTrace();
						}
						return;
