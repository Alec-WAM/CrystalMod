...
public class CubeBuilder
{
	...
	private final EnumMap<EnumFacing, TextureAtlasSprite> textures = new EnumMap<EnumFacing, TextureAtlasSprite>( EnumFacing.class );

	private EnumSet<EnumFacing> drawFaces = EnumSet.allOf( EnumFacing.class );

	private final EnumMap<EnumFacing, Vector4f> customUv = new EnumMap<EnumFacing, Vector4f>( EnumFacing.class );
