package com.alec_wam.CrystalMod.tiles.pipes.power.rf;
...
public class RFPowerPipeNetwork extends AbstractPipeNetwork {

	NetworkRFPowerManager powerManager;
	...
	public void init(TileEntityPipe tile, Collection<TileEntityPipe> connections, World world) {
	    ...
	    powerManager = new NetworkRFPowerManager(this, world);
    ...
    public NetworkRFPowerManager getPowerManager() {
    	return powerManager;
    }
	...
	public void addPipe(TileEntityPipe pipEntry) {
	    ...
	    if(!(pipEntry instanceof TileEntityPipePowerRF))return;
	    TileEntityPipePowerRF pip = (TileEntityPipePowerRF)pipEntry;
	...
	public void powerReceptorAdded(TileEntityPipePowerRF powerPipe, EnumFacing direction, int x, int y, int z, IPowerInterface powerReceptor) {
    ...
    public static class ReceptorEntry {
	    ...
	    TileEntityPipePowerRF emmiter;
	    BlockPos coord;
	    EnumFacing direction;
	
	    IPowerInterface powerInterface;
	
	    public ReceptorEntry(IPowerInterface powerReceptor, BlockPos coord, TileEntityPipePowerRF emmiter, EnumFacing direction) {
