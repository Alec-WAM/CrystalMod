package com.alec_wam.CrystalMod.tiles.workbench;
...
public class BlockCrystalWorkbench extends EnumBlock<BlockCrystalWorkbench.WorkbenchType> implements ITileEntityProvider, ICustomModel  {
	...
	public static enum WorkbenchType implements IStringSerializable, com.alec_wam.CrystalMod.blocks.EnumBlock.IEnumMeta{
		BLUE, RED, GREEN, DARK;
