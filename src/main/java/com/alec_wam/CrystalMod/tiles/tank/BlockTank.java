package com.alec_wam.CrystalMod.tiles.tank;
...
public class BlockTank extends EnumBlock<BlockTank.TankType> implements ITileEntityProvider, ICustomModel {
	...
	public static enum TankType implements IStringSerializable, com.alec_wam.CrystalMod.blocks.EnumBlock.IEnumMeta{
