...
public class RotatedAxes
{
	...
	{
		rotationMatrix.rotate(rotateBy * 3.14159265F / 180F, getYAxis().normal());
		convertMatrixToAngles();
	}
	...
	{
		rotationMatrix.rotate(rotateBy * 3.14159265F / 180F, getZAxis().normal());
		convertMatrixToAngles();
	}
	...
	{
		rotationMatrix.rotate(rotateBy * 3.14159265F / 180F, getXAxis().normal());
		convertMatrixToAngles();
	}
