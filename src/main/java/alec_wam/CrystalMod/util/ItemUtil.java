...
public class ItemUtil {
	...
	public static void setPlayerHandSilently(PlayerEntity player, Hand hand, ItemStack stack){
	...
	public static IItemHandler getExternalItemHandler(IWorld world, BlockPos pos, Direction face){
	...
	public static String getDyeName(DyeColor dye){
	...
	public static void dropItemOnSide(World worldIn, BlockPos pos, ItemStack itemStack, Direction sideHit) {
	...
	public static void spawnItemInWorldWithoutMotion(ItemEntity entityItem) {
