...
public class LayerDisguiseCape implements LayerRenderer<AbstractClientPlayer>
{
    private final RenderMiniPlayer playerRenderer;

    public LayerDisguiseCape(RenderMiniPlayer playerRendererIn)
    {
