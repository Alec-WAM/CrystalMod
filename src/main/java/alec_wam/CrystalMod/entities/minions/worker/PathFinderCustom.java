...
public class PathFinderCustom
{
    ...
    public PathFinderCustom(NodeProcessor processor)
    {
    ...
    @Nullable
    public Path findPath(IBlockAccess worldIn, EntityLiving p_186334_2_, double p_186334_3_, double p_186334_5_, double p_186334_7_, float p_186334_9_)
    {
        this.path.clearPath();
