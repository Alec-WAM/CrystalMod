...
public class ModelMinionBase extends ModelBiped
{
    ...
    public ModelMinionBase(float p_i46304_1_, boolean p_i46304_2_)
    {
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        boolean sitting = entityIn instanceof EntityMinionBase ? ((EntityMinionBase)entityIn).isSitting() : false;
