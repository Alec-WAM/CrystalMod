...
public class ItemBambooBoat extends Item
{
    public ItemBambooBoat()
    {
        this.maxStackSize = 1;
        this.setCreativeTab(CreativeTabs.TRANSPORTATION);
        ModItems.registerItem(this, "bambooboat");
    }
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                EntityBambooBoat entityboat = new EntityBambooBoat(worldIn, raytraceresult.hitVec.xCoord, flag1 ? raytraceresult.hitVec.yCoord - 0.12D : raytraceresult.hitVec.yCoord, raytraceresult.hitVec.zCoord);
