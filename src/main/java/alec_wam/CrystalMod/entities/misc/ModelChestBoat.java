...
public class ModelChestBoat extends ModelBase implements IMultipassModel
{
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
        ...
        EntityBoatChest entityboat = (EntityBoatChest)entityIn;
    ...
    protected void renderPaddle(EntityBoatChest boat, int paddle, float scale, float limbSwing)
    {
        float f = 40.0F;
