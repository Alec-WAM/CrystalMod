...
public class ModelTamedPolarBear extends ModelQuadruped
{
    public ModelTamedPolarBear()
    {
        super(12, 0.0F);
    ...
    {
    	EntityTamedPolarBear bear = (EntityTamedPolarBear)entitylivingbaseIn;
    	super.setLivingAnimations(entitylivingbaseIn, limbSwing, limbSwingAmount, partialTickTime);
        /*if (bear.isSitting())
        {
            //this.body.setRotationPoint(0.0F, 9.0F, 12.0F);
            //this.body.rotateAngleX = 5f;
            ...
            this.body.setRotationPoint(-2.0F, 9.0F, 12.0F);
            this.body.rotateAngleX = this.body.rotateAngleY = this.body.rotateAngleZ = 0.0f;
            this.leg1.setRotationPoint(-3.5F, 14.0F, 6.0F);
            this.leg2.setRotationPoint(3.5F, 14.0F, 6.0F);
            this.leg3.setRotationPoint(-2.5F, 14.0F, -7.0F);
            this.leg4.setRotationPoint(2.5F, 14.0F, -7.0F);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        float f1 = ((EntityTamedPolarBear)entityIn).getStandingAnimationScale(f);
        EntityTamedPolarBear bear = ((EntityTamedPolarBear)entityIn);
        f1 = f1 * f1;
        float f2 = 1.0F - f1;
        boolean sitting = bear.isSitting();
        
        if(sitting){
        	this.body.rotateAngleX = -5f;
        	this.body.rotationPointY = 15.0F;

            this.leg1.rotateAngleX = this.leg2.rotateAngleX = -0.5f;
