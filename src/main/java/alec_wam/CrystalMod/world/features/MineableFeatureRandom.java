...
public class MineableFeatureRandom extends Feature<MinableRandomConfig> {
	@Override
	public boolean func_212245_a(IWorld world, IChunkGenerator<? extends IChunkGenSettings> p_212245_2_, Random rand, BlockPos pos, MinableRandomConfig config) {
                        ...
                        if (d12 * d12 + d13 * d13 < 1.0D)
                        {
                            for (int j2 = l; j2 <= k1; ++j2)
                            {
                                ...
                                if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D)
                                {
                                    ...
                                    if (state.getBlock().isReplaceableOreGen(state, worldIn.getWorld(), blockpos, config.canReplace))
                                    {
