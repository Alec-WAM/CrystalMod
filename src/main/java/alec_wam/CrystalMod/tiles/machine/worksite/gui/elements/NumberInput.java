...
public class NumberInput extends Text {
	...
	public NumberInput(int topLeftX, int topLeftY, int width,
			float defaultText, IWidgetSelection selector) {
	...
	/**
	 * anonymous classes should implement this for a callback for when value is
	 * updated/changed via user input (either manual, mouse,or keyboard)
	 * 
	 * @param value
	 */
