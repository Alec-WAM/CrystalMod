...
public class ContainerAdvDispenser extends Container
{
    private final TileAdvDispenser dispenser;

    public ContainerAdvDispenser(IInventory playerInventory, TileAdvDispenser dispenser)
    {
