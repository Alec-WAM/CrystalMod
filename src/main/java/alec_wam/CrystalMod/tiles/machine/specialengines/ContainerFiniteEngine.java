...
public class ContainerFiniteEngine extends Container
{
    private final TileFiniteEngine engine;

    public ContainerFiniteEngine(IInventory playerInventory, TileFiniteEngine engine)
    {
        this.engine = engine;
