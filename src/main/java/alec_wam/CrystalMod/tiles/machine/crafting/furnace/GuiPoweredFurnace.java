...
public class GuiPoweredFurnace extends GuiElementContainer implements IRecipeShownListener {
	...
	public GuiPoweredFurnace(EntityPlayer player, TileEntityPoweredFurnace tileFurnace)
    {
        super(new ContainerPoweredFurnace(player, tileFurnace), TEXTURE);
	...
	public void initGui(){
	    ...
	    this.addButton(new GuiButtonImage(10, this.guiLeft + 28, this.height / 2 - 49, 20, 18, 0, 0, 19, RECIPE_BUTTON_TEXTURE) {
	    	
	    	public void onClick(double mouseX, double mouseY) {
	    		GuiPoweredFurnace.this.recipeBook.func_201518_a(GuiPoweredFurnace.this.canRenderRecipeBook);
	    		GuiPoweredFurnace.this.recipeBook.toggleVisibility();
	    		GuiPoweredFurnace.this.guiLeft = GuiPoweredFurnace.this.recipeBook.updateScreenPosition(GuiPoweredFurnace.this.canRenderRecipeBook, GuiPoweredFurnace.this.width, GuiPoweredFurnace.this.xSize);
	    		this.setPosition(GuiPoweredFurnace.this.guiLeft + 28, GuiPoweredFurnace.this.height / 2 - 49);
	    	}
	    });
	}
