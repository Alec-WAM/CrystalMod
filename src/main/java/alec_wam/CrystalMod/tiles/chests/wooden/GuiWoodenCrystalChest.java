...
public class GuiWoodenCrystalChest extends GuiContainer {
    ...
    public enum GUI {
        ...
        public static GuiWoodenCrystalChest buildGUI(WoodenCrystalChestType type, IInventory playerInventory, IInventory chestInventory)
        {
            return new GuiWoodenCrystalChest(values()[type.ordinal()], playerInventory, chestInventory);
        }
    }
    ...
    private GuiWoodenCrystalChest(GUI type, IInventory player, IInventory chest)
    {
