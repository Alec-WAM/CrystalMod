...
public class WoodenCrystalChestContainer extends Container {
    private WoodenCrystalChestType type;
    private PlayerEntity player;
    private IInventory chest;
    
    public WoodenCrystalChestContainer(int windowId, PlayerInventory playerInventory, IInventory chestInventory, WoodenCrystalChestType type, int xSize, int ySize)
    {
    	super(null, windowId);
