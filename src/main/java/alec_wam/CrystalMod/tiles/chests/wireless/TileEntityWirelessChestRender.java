...
public class TileEntityWirelessChestRender extends TileEntityRenderer<TileEntityWirelessChest>
{
	...
	public static void renderChest(double x, double y, double z, int code, Direction facing, boolean owned, float lidangle, int breakStage){
		if (breakStage >= 0)
		{
        ...
        GlStateManager.translatef(0.5F, 0.5F, 0.5F);
        float offset = (facing == Direction.EAST || facing == Direction.WEST) ? 180 : 0;
	...
	public static void renderButtons(int code, Direction facing, double lidAngle) {
    ...
    private static void drawButton(int button, int color, Direction facing, double lidAngle) {
