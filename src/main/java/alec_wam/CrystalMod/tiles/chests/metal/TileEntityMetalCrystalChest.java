...
public class TileEntityMetalCrystalChest extends TileEntityInventory implements IInteractionObject
{
	...
	public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn) {
		return new ContainerMetalCrystalChest(playerInventory, this, type, 0, 0);
	}
