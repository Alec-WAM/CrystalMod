...
public class TileWoodenCrystalChest extends TileEntityInventory
{
    ...
    public TileWoodenCrystalChest()
    {
        this(WoodenCrystalChestType.BLUE);
    }

    protected TileWoodenCrystalChest(WoodenCrystalChestType type)
    {
        super("", type.size);
        this.type = type;
    }
    ...
    public WoodenCrystalChestType getType()
    {
        return type;
    }
    ...
    public void update()
    {
        ...
        {
            getWorld().addBlockEvent(pos, ModBlocks.crystalWoodenChest, 3, ((numUsingPlayers << 3) & 0xF8) | (facing & 0x7));
        }
    ...
    public void openInventory(EntityPlayer player)
    {
        ...
        numUsingPlayers++;
        getWorld().addBlockEvent(pos, ModBlocks.crystalWoodenChest, 1, numUsingPlayers);
    }
    ...
    public TileWoodenCrystalChest updateFromMetadata(int l)
    {
        if (hasWorld() && getWorld().isRemote)
        {
            if (l != type.ordinal())
            {
            	getWorld().setTileEntity(pos, WoodenCrystalChestType.makeEntity(l));
                return (TileWoodenCrystalChest) getWorld().getTileEntity(pos);
            }
        }
        return this;
    }
