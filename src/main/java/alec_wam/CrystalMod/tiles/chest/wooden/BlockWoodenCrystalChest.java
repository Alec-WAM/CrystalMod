...
{
    public static final PropertyEnum<WoodenCrystalChestType> VARIANT_PROP = PropertyEnum.create("variant", WoodenCrystalChestType.class);

    public BlockWoodenCrystalChest()
    {
        super(Material.WOOD);

        this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANT_PROP, WoodenCrystalChestType.BLUE));
    ...
    @SideOnly(Side.CLIENT)
    public <T extends TileWoodenCrystalChest> void registerTileEntitySpecialRenderer(Class<T> type)
    {
        ClientRegistry.bindTileEntitySpecialRenderer(type, new TileWoodenCrystalChestRenderer<T>());
    }
    ...
    {
        return WoodenCrystalChestType.makeEntity(metadata);
    }
    ...
    {
        return this.getDefaultState().withProperty(VARIANT_PROP, WoodenCrystalChestType.values()[meta]);
    }
