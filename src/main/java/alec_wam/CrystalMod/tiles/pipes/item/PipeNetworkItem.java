...
public class PipeNetworkItem extends PipeNetworkBase<TileEntityPipeItem>{
	...
	public boolean addPipe(TileEntityPipeBase pipe){
		...
		if(super.addPipe(pipe)){
			...
			for (Direction facing : pip.getExternalConnections()) {
	...
	public void inventoryAdded(TileEntityPipeItem itemPipe, Direction direction) {
	...
	public NetworkInventory getInventory(TileEntityPipeItem pipe, Direction dir) {
	...
	public void inventoryRemoved(TileEntityPipeItem itemPipe, Direction facing) {
