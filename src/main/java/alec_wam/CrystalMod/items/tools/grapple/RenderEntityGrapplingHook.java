...
public class RenderEntityGrapplingHook<T extends Entity> extends Render<T>
{
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        if ((this.renderManager.options == null || this.renderManager.options.thirdPersonView <= 0) && e == CrystalMod.proxy.getClientPlayer())
        {
            ...
            d4 = e.prevPosX + (e.posX - e.prevPosX) * partialTicks + vec3d.xCoord;
            d5 = e.prevPosY + (e.posY - e.prevPosY) * partialTicks + vec3d.yCoord;
            d6 = e.prevPosZ + (e.posZ - e.prevPosZ) * partialTicks + vec3d.zCoord;
            d7 = e.getEyeHeight();
        }
        else
        {
