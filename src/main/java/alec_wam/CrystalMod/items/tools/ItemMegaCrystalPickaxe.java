...
public class ItemMegaCrystalPickaxe extends ItemCrystalPickaxe implements IMegaTool {
    ...
    public void initModel() {
		...
		for(String color : new String[]{"blue", "red", "green", "dark", "pure"}){
			ModelResourceLocation loc = new ModelResourceLocation("crystalmod:tool/megapick", "color="+color);
