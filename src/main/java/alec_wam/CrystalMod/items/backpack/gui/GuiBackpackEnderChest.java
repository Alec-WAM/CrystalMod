...
public class GuiBackpackEnderChest extends GuiBackpackBase
{
    public static final int BTN_ID_FIRST_MOVE_ITEMS    = 0;

    protected final EntityPlayer player;
    protected final ContainerBackpackEnderChest container;
    ...
    public GuiBackpackEnderChest(ContainerBackpackEnderChest container)
    {
        super(container, 198+18, 256, "crystalmod:textures/gui/backpack/enderchest.png");
    ...
    {
    	Slot slot = this.container.getSlot(this.invSize + 36);
    	if(slot  !=null){
    ...
    protected void drawGuiContainerBackgroundLayer(float gameTicks, int mouseX, int mouseY)
    {
        ...
        if (this.invModular.isUseableByPlayer(this.player) == false)
        {
            ...
            for (int i = 0; i < BackpackUtils.MAIN_SIZE; i++)
            {
    ...
    {
    	this.fontRendererObj.drawString(I18n.format("container.enderchest"), 29, 12, 0x404040);
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        if (button.id >= (BTN_ID_FIRST_MOVE_ITEMS + 6) && button.enabled)
        {
