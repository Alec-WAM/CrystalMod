...
public class GuiBackpackCrafting extends GuiBackpackBase
{
    public static final int BTN_ID_FIRST_MOVE_ITEMS    = 0;

    protected final EntityPlayer player;
    protected final ContainerBackpackCrafting container;
    ...
    public GuiBackpackCrafting(ContainerBackpackCrafting container)
    {
        super(container, 198+18, 256, "crystalmod:textures/gui/backpack/crafting.png");
    ...
    {
        this.fontRendererObj.drawString(I18n.format("container.crafting"), 52, 12, 0x404040);
