...
public class GuiBackpack extends GuiBackpackBase
{
    ...
    protected final ContainerBackpack container;
    ...
    {
        super(container, 198+18, 170, "crystalmod:textures/gui/backpack/main.png");
    ...
    {
        this.fontRendererObj.drawString(I18n.format(Lang.prefix+"container.backpack"), 29, 6, 0x404040);
    }
