...
public abstract class ElementBase {
	...
	protected GuiElementContainer<?> gui;
	...
	public ElementBase(GuiElementContainer<?> gui, int posX, int posY) {
	...
	public ElementBase(GuiElementContainer<?> gui, int posX, int posY, int width, int height) {
	...
	public void drawTexturedModalRect(int x, int y, int u, int v, int width, int height) {
		Screen.blit(x, y, u, v, width, height, texW, texH);
	}
	...
	public boolean onMouseWheel(double mouseX, double mouseY, double movement) {
	...
	public final GuiElementContainer<?> getContainerScreen() {
		return gui;
	}
