    ...
    public void renderByItem(ItemStack itemStackIn)
    {
        ...
        else if (block instanceof BlockBattery)
        {
        	...
        	if(ItemNBTHelper.verifyExistance(itemStackIn, TileEntityBattery.NBT_DATA)){
        		NBTTagCompound nbt = ItemNBTHelper.getCompound(itemStackIn).getCompound(TileEntityBattery.NBT_DATA);
        	...
        	TileEntityBatteryRender.renderMeter(EnumFacing.NORTH, energy, maxEnergy, type == EnumCrystalColorSpecialWithCreative.CREATIVE);
        }
        else
        {
