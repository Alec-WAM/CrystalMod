...
public class BlockFancyLadder extends Block implements ICustomModel
{
    ...
    public static final PropertyEnum<FancyLadderType> TYPE = PropertyEnum.<FancyLadderType>create("type", FancyLadderType.class);
    
    
    public BlockFancyLadder()
    {
    ...
    {
    	FancyLadderType type = FancyLadderType.byMetadata((meta & 3));
    ...
    public static enum FancyLadderType implements IEnumMeta, IStringSerializable {
    	WIDE, ARROW, DIAMOND, HELIX;
		...
		public static FancyLadderType byMetadata(int meta)
        {
