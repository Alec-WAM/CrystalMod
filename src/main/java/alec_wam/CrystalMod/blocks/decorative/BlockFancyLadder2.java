...
public class BlockFancyLadder2 extends Block implements ICustomModel
{
    ...
    public static final PropertyEnum<FancyLadderType2> TYPE = PropertyEnum.<FancyLadderType2>create("type", FancyLadderType2.class);
    ...
    {
    	FancyLadderType2 type = FancyLadderType2.byMetadata((meta & 3));
    ...
    public static enum FancyLadderType2 implements IEnumMeta, IStringSerializable {
    	CIRCLE, LATTICED, X;
		...
		public static FancyLadderType2 byMetadata(int meta)
        {
